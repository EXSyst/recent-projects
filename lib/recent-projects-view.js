...
module.exports = RecentProjectsView = (function(superClass) {
    ...
    RecentProjectsView.prototype.createNewFile = function() {
        ...
        return atom.commands.dispatch(atom.views.getView(atom.workspace), 'application:new-file');
    };

    RecentProjectsView.prototype.closeAfterOpenProject = function() {
        var showTree;
        if ((atom.project.path != null) || atom.views.getView(atom.workspace).getActivePaneView().getItems().length > 1 || parseFloat(atom.getVersion()) >= 0.124) {
            atom.workspace.getActivePane().removeItem(this);
            showTree = function() {
