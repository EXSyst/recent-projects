...
module.exports = RecentProjectsView = (function(superClass) {
	 ...
	 * Open the selected project
	 */
	RecentProjectsView.prototype.starSelected = function() {
		if (this.selectedEntry == null) {
			return;
		}
		...
		return projects.forEach(function(project) {
			if (!project.equals(atom.project)) { // If not the current project
				var entry = $$(function() {
					var _this = this;
					return this.li({
						"class": 'project-entry btn btn-default icon icon-repo' + (project.getStared() ? ' stared' : '')
					}, function() {
						_this.div({
							"class": 'project-meta'
						}, function() {
	 ...
	 * @param Object entry
	 */
	RecentProjectsView.prototype.starProject = function(project, entry) {
		var stared = !project.getStared();
		project.setStared(stared);
