...
module.exports = RecentProjectsView = (function(superClass) {
            ...
            return function(err, projects) {
                if (err != null) {
                    ...
                    return projects.forEach(function(project) {
                        ...
                        return _this.setDetails(project);
                    });
                }
            };
        })(this));
    ...
    RecentProjectsView.prototype.setList = function(projects) {
        ...
        return projects.forEach((function(_this) {
            return function(project) {
                ...
                // TODO: Fix this
                if (project.getPaths() !== atom.project.getPaths()) {
                    entry = $$(function() {
                        return this.li({
                            'data-uri': JSON.stringify(project.getPaths()),
    ...
    RecentProjectsView.prototype.setDetails = function(project) {
        var entry;
        entry = this.projectList.children().filter(function() {
            return this.getAttribute('data-uri') === JSON.stringify(project.getPaths());
        });
        if (entry.length) {
