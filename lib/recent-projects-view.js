...
module.exports = (function (_ScrollView) {
	...
	function RecentProjectsView() {
		...
		return _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(RecentProjectsView)).call.apply(_Object$getPrototypeO, [this].concat(args)));
	}
