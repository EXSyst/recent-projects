var MAX_RECENT_PROJECTS = null;
atom.config.observe('recent-projects.maxProjects', function(maxProjects) {
    MAX_RECENT_PROJECTS = maxProjects;
});
...
var read = function(callback) {
    ...
    return callback(null, projects.splice(MAX_RECENT_PROJECTS));
};
